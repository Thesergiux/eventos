...
@section('tab_title', 'Editar especialista | ' . config('app.name'))
@section('description', 'Editar especialista.')
...
<section class="mb-16">
    ...
    <div class="fluid-container mb-16">
        <p class="mb-12">
            ...
            <base-form action="{{ url('admin/especialista/'. $specialist->id .'/actualizar') }}"
                method="put"
                        ...
                        <div class="md:row">
                            <div class="md:col">
                                ...
                                <div class="form-control">
                                    ...
                                    <text-field name="name" v-model="fields.name" maxlength="80" initial="{{ $specialist->name }}"></text-field>
                            ...
                            <div class="md:col">
                                <div class="form-control">
                                    ...
                                    <text-field name="speciality" v-model="fields.speciality" maxlength="80" initial="{{ $specialist->speciality }}"></text-field>
                        ...
                        <div class="md:row">
                            <div class="md:col-1/2">
                                ...
                                <div class="form-control">
                                    ...
                                    <text-field name="phone" v-model="fields.phone" maxlength="80" initial="{{ $specialist->phone }}"></text-field>
                            ...
                            <div class="md:col-1/2">
                                <div class="form-control">
                                    ...
                                    <text-field name="email" v-model="fields.email" maxlength="80" initial="{{ $specialist->email }}"></text-field>
                            ...
                            <div class="md:col">
                                ...
                                <div class="form-control">
                                    ...
                                    <text-area-tiny 
                                        ...
                                        :initial-value="{{ json_encode($specialist->description) }}">
                                    </text-area-tiny>
                        ...
                        <div class="md:row">
                            <div class="preview-aside">
                                <figure class="preview-aside__box preview-box">
                                    <img class="preview-box__img" src="{{ url($specialist->photo) }}" alt="" ref="thumb">                                  
                        ...
                        <div class="md:row">
                            <div class="preview-aside">
                                <figure class="preview-aside__box preview-box">
                                    ...
                                    <img class="preview-box__img" src="{{ url($specialist->cover) }}" alt="" ref="thumb">                                  
                                    <figcaption class="preview-box__caption">
                                        Imagen actual
                                    </figcaption>
                                </figure>
