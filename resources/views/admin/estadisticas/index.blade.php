...
@section('tab_title', 'Estadísticas de servicios | ' . config('app.name'))
@section('description', 'Lista de Estadísticas de servicios.')
...
@section('content')
    ...
    <div class="fluid-container mb-16">
        ...
        <div class="md:row">
            ...
            <div class="md:col-1/3">
                <section class="db-panel">
                    <h3 class="db-panel__title">
                        Estadísticas de Ingresos por sucursal
                    </h3>
            ...
            <div class="md:col-1/3">
                <section class="db-panel">
                    ...
                    <canvas id="canvasbypayment" height="70"></canvas>
                </section>
            </div>
        </div>
    </div>
    ...
    <script type="application/javascript">
        var amount = <?php echo $services_by_amount; ?>;
        var amountbyBranch = <?php echo $services_branch_by_amount; ?>;
        var amountbyPayment = <?php echo $services_payment_by_amount; ?>;
        ...
        var pieChartDataTotal = {
            labels: Object.keys(amountbyPayment),
            datasets: [{
                label: 'Total',
                backgroundColor: ["#409dcd","#456c7f","53c0f5"],
                data: Object.values(amountbyPayment)
            }]
        };
           ...
           var ctxb = document.getElementById("canvasbybranch").getContext("2d");
            window.myBarb = new Chart(ctxb, {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: 'Total de Ingresos por sucursal'
                    }
                }
            });
            var ctxp = document.getElementById("canvasbypayment").getContext("2d");
            window.myPiep = new Chart(ctxp, {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: 'Total de Ingresos por tipo de pago'
                    }
                }
            });
        };
